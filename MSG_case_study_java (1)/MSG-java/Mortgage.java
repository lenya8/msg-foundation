...
class Mortgage extends Asset
{
...

  {
	...
	inFile.close ();
        ...
        System.out.println("Inicial: " + tempoInicial + "E tempo final: " + tempoFinal);
        System.out.println("Tempo de execução de totalWeeklyNetPayments: " + tempoTotal);
  ...
  //
  {
	...
	if (mortgageFile.exists ())
	{
	  ...
	  inFile.close ();
        ...
        long tempoFinal = System.currentTimeMillis();
        long tempoFind = tempoFinal - tempoInicial;
        System.out.println("Tempo total find: " + tempoFind);
        return found;
    }
    catch (Exception e)
    {
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //
  {
	...
	System.out.println ("\t" + e);
      ...
      long tempoRead = tempoFinal - tempoInicial;
      System.out.println("Tempo read: " + tempoRead);
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //
  {
	...
	System.out.println ("\t" + e);
      ...
      long tempoFinal = System.currentTimeMillis();
      long tempoWrite = tempoFinal - tempoInicial;
      System.out.println("Tempo write: " + tempoWrite);
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //
  {
	...
	tempMortgageFile.renameTo (mortgageFile);
        long tempoFinal = System.currentTimeMillis();
        long tempoPerformDeletion = tempoFinal - tempoInicial;
        System.out.println("Tempo perform deletion: " + tempoPerformDeletion);
    }
    catch (Exception e)
    {
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //
  {
	...
	tempMortgageFile.renameTo (mortgageFile);
        ...
        long tempoSave = tempoFinal - tempoInicial;
        System.out.println("Tempo save: " + tempoSave);
    }
    catch (Exception e)
    {
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  //
  {
	...
	System.out.println ("\t" + e);
      ...
      long tempoReadMortgageData = tempoFinal - tempoInicial;
      System.out.println("Tempo readMortgageData: " + tempoReadMortgageData);
